...
[[ $binary_type == native || $binary_type == native_x86_64 || $binary_type == solcjs ]] || { >&2 echo "Invalid binary type: ${binary_type}"; exit 1; }
...
if [[ $binary_type == native || $binary_type == native_x86_64 ]]; then
